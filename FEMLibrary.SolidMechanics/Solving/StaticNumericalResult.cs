...
namespace FEMLibrary.SolidMechanics.Solving
{
    public class StaticNumericalResult:INumericalResult
    {
        ...
        public StaticNumericalResult(List<IFiniteElement> elements, Vector result)
        {
            Elements = elements;
            U = result;
        }

        public StaticNumericalResult()
        {
        ...
        public Vector GetResultAtPoint(Point point, double t)
        {
            ...
            if (element != null)
            {
                ...
                result = GetUByElement(element)*finiteElementApproximationMatrix;
            }
            return result;
        }
        ...
        public string Name
        {
            get { return "Stationary nonlinear result"; }
        }
    }
}
